...
class orbitalElements(object):
    ...
    def clone(self):
        return orbitalElements(self.a, self.e, self.i, self.longascend, self.argper, self.trueanom, self.position,
                               self.velocity, self.G, self.totalMass)
    ...
    def calcOrbitTrack(self, npoints):
        ...
        if (orbit.e < 1.0):
            ...
            nu = np.linspace(self.trueanom - np.arccos(1.0 / self.e), self.trueanom + np.arccos(1.0 / self.e),
                             num=npoints)
